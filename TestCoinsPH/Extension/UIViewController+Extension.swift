...
extension UIViewController {
    ...
    func showLoading() {
        DispatchQueue.main.async {
            ...
            progressHUD.backgroundView.backgroundColor = UIColor.black.withAlphaComponent(0.5)
            progressHUD.contentColor = UIColor.init(named: "mainColor")
            progressHUD.bezelView.color = .clear
            progressHUD.bezelView.style = .solidColor
            progressHUD.tintColor = UIColor.init(named: "mainColor")
        }
    }
